...
class WC_ScanForPay_Wechat extends WC_Payment_Gateway{	
	...
	public function __construct(){
		$this->id = "scanforpay-wechat"; // 你的网关的唯一ID，例如，“your_gateway”
		$this->icon = "https://pay.scanforpay.com/static/plugin/wechat.svg";
		//如果你想要付款字段在结算页面显示，就设置为true（如果做的直接集成） 
		$this->has_fields = false;
		//显示在后台的付款方式的标题
		$this->method_title = 'ScanForPay-Wechat Pay';
		//显示在后台的付款方式的描述。
		$this->method_description = 'Alipay & AlipayHK & Wechat Pay收款由<a href="https://hk.scanforpay.com" target="_blank">ScanForPay</a>提供';
	...
	function process_payment( $order_id ) {
		...
		$result = ScanForPay_API::create_order($order, 'Wechat');
